...
export class InitialSchema1767118691573 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_companies_role_enum" AS ENUM('SUPER_ADMIN', 'COMPANY_ADMIN', 'MANAGER', 'LANDLORD', 'STAFF', 'TENANT')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."properties_propertytype_enum" AS ENUM('APARTMENT', 'HOUSE', 'COMMERCIAL', 'CONDO', 'TOWNHOUSE', 'MIXED_USE')`);
        await queryRunner.query(`CREATE TYPE "public"."properties_status_enum" AS ENUM('AVAILABLE', 'OCCUPIED', 'MAINTENANCE', 'UNAVAILABLE')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_9ea179f3777f6d78a274a3f201" ON "properties" ("companyId", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_cec911f4e8121d16a8f9a7b031" ON "properties" ("companyId") `);
        await queryRunner.query(`CREATE TYPE "public"."units_status_enum" AS ENUM('AVAILABLE', 'OCCUPIED', 'MAINTENANCE', 'UNAVAILABLE')`);
        await queryRunner.query(`CREATE TYPE "public"."units_unittype_enum" AS ENUM('STUDIO', 'ONE_BEDROOM', 'TWO_BEDROOM', 'THREE_BEDROOM', 'FOUR_PLUS_BEDROOM', 'SHOP', 'COMMERCIAL', 'STORAGE', 'PARKING', 'PENTHOUSE')`);
        await queryRunner.query(`CREATE TYPE "public"."units_leasetype_enum" AS ENUM('SHORT_TERM', 'LONG_TERM', 'MONTH_TO_MONTH')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_452076bf093c729d6fcf363a9f" ON "units" ("propertyId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_43714c4d2bdfcca2c28fa2c4ea" ON "units" ("unitType") `);
        await queryRunner.query(`CREATE INDEX "IDX_37768e6e1261ee85920f8a387d" ON "units" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_f0be597f225559f5550ef4d640" ON "units" ("companyId") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tenant_profiles_status_enum" AS ENUM('PENDING', 'ACTIVE', 'FORMER')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d6329fff49d3b9f3c6b1dabb06" ON "tenant_profiles" ("companyId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_9484191f37ec856d966f87c0a4" ON "tenant_profiles" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_de6f7c888d6661227616ff312f" ON "tenant_profiles" ("companyId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b8a59063604d0b6d659548da5a" ON "tenant_profiles" ("userId") `);
        await queryRunner.query(`CREATE TYPE "public"."leases_status_enum" AS ENUM('DRAFT', 'ACTIVE', 'EXPIRED', 'TERMINATED', 'RENEWED')`);
        await queryRunner.query(`CREATE TYPE "public"."leases_leasetype_enum" AS ENUM('SHORT_TERM', 'LONG_TERM', 'MONTH_TO_MONTH')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_3f53b37aabe10e2a1033d05b2c" ON "leases" ("endDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_bf00ca6c0fc2f9202dda9304ff" ON "leases" ("startDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_999e1e0b307266b4578e02fca5" ON "leases" ("unitId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_f04ca7b565c329d2a6f1b73c0f" ON "leases" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_35ba530fe49310f0dc16748b55" ON "leases" ("companyId") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_paymentmethod_enum" AS ENUM('CASH', 'BANK', 'MPESA', 'CARD', 'CHECK', 'OTHER')`);
        await queryRunner.query(`CREATE TYPE "public"."payments_paymenttype_enum" AS ENUM('RENT', 'DEPOSIT', 'LATE_FEE', 'UTILITY', 'PET_DEPOSIT', 'PET_RENT', 'MAINTENANCE', 'OTHER')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d94f28cc215bf9e685c73e014b" ON "payments" ("leaseId", "paymentDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_39eee28b1f5056d199f4ed2c1c" ON "payments" ("companyId", "tenantId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d0e156af6bcda64dc420f44ae1" ON "payments" ("leaseId") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."company_invitations_role_enum" AS ENUM('SUPER_ADMIN', 'COMPANY_ADMIN', 'MANAGER', 'LANDLORD', 'STAFF', 'TENANT')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_5e5340e04f80f443829089af80" ON "company_invitations" ("email", "companyId") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tenant_invitations_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'EXPIRED', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_bd230c7339c22fed2aa387529e" ON "tenant_invitations" ("tenantProfileId") `);
        await queryRunner.query(`CREATE INDEX "IDX_dbb992b1e69267c7b89e45307c" ON "tenant_invitations" ("email", "companyId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b77424e8049ff41872f6b0291a" ON "tenant_invitations" ("email") `);
        await queryRunner.query(`CREATE INDEX "IDX_c8099066c8aa54ea0df9db0f9d" ON "tenant_invitations" ("companyId") `);
        ...
        await queryRunner.query(`ALTER TABLE "user_companies" ADD CONSTRAINT "FK_fbcec9c4908de8338081b5bfeb0" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "properties" ADD CONSTRAINT "FK_cec911f4e8121d16a8f9a7b031f" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "units" ADD CONSTRAINT "FK_f0be597f225559f5550ef4d640f" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tenant_profiles" ADD CONSTRAINT "FK_b8a59063604d0b6d659548da5a9" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tenant_profiles" ADD CONSTRAINT "FK_de6f7c888d6661227616ff312f4" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leases" ADD CONSTRAINT "FK_175030e58c0d1accdb888a431d8" FOREIGN KEY ("tenantId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leases" ADD CONSTRAINT "FK_41ddb25063485103a828efc4084" FOREIGN KEY ("unitId") REFERENCES "units"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leases" ADD CONSTRAINT "FK_35ba530fe49310f0dc16748b557" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leases" ADD CONSTRAINT "FK_e107f3926aa0bebdde88243b5cb" FOREIGN KEY ("landlordUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leases" ADD CONSTRAINT "FK_30581aa3255a616a0dd033dbc29" FOREIGN KEY ("renewedFromLeaseId") REFERENCES "leases"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leases" ADD CONSTRAINT "FK_9db0d3ef77c565e7bf7b3a8ea7c" FOREIGN KEY ("renewedToLeaseId") REFERENCES "leases"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payments" ADD CONSTRAINT "FK_d0e156af6bcda64dc420f44ae1c" FOREIGN KEY ("leaseId") REFERENCES "leases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payments" ADD CONSTRAINT "FK_98a04cdcbac4f6a2c55c7d19350" FOREIGN KEY ("tenantId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" ADD CONSTRAINT "FK_b44a43463c1f091a11f768d5389" FOREIGN KEY ("recordedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "company_invitations" ADD CONSTRAINT "FK_888027e25f3cd96aca2b013e6d3" FOREIGN KEY ("invitedBy") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tenant_invitations" ADD CONSTRAINT "FK_c8099066c8aa54ea0df9db0f9d4" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tenant_invitations" ADD CONSTRAINT "FK_286ec915ac82dacb01b4f8aba82" FOREIGN KEY ("invitedBy") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tenant_invitations" ADD CONSTRAINT "FK_bd230c7339c22fed2aa387529ee" FOREIGN KEY ("tenantProfileId") REFERENCES "tenant_profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tenant_invitations" DROP CONSTRAINT "FK_bd230c7339c22fed2aa387529ee"`);
        await queryRunner.query(`ALTER TABLE "tenant_invitations" DROP CONSTRAINT "FK_286ec915ac82dacb01b4f8aba82"`);
        await queryRunner.query(`ALTER TABLE "tenant_invitations" DROP CONSTRAINT "FK_c8099066c8aa54ea0df9db0f9d4"`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP CONSTRAINT "FK_b44a43463c1f091a11f768d5389"`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP CONSTRAINT "FK_d0e156af6bcda64dc420f44ae1c"`);
        await queryRunner.query(`ALTER TABLE "leases" DROP CONSTRAINT "FK_9db0d3ef77c565e7bf7b3a8ea7c"`);
        await queryRunner.query(`ALTER TABLE "leases" DROP CONSTRAINT "FK_30581aa3255a616a0dd033dbc29"`);
        await queryRunner.query(`ALTER TABLE "leases" DROP CONSTRAINT "FK_e107f3926aa0bebdde88243b5cb"`);
        await queryRunner.query(`ALTER TABLE "leases" DROP CONSTRAINT "FK_35ba530fe49310f0dc16748b557"`);
        ...
        await queryRunner.query(`ALTER TABLE "tenant_profiles" DROP CONSTRAINT "FK_de6f7c888d6661227616ff312f4"`);
        await queryRunner.query(`ALTER TABLE "tenant_profiles" DROP CONSTRAINT "FK_b8a59063604d0b6d659548da5a9"`);
        await queryRunner.query(`ALTER TABLE "units" DROP CONSTRAINT "FK_f0be597f225559f5550ef4d640f"`);
        await queryRunner.query(`ALTER TABLE "units" DROP CONSTRAINT "FK_546f4aa111022d983a32103048b"`);
        await queryRunner.query(`ALTER TABLE "properties" DROP CONSTRAINT "FK_cec911f4e8121d16a8f9a7b031f"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c8099066c8aa54ea0df9db0f9d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b77424e8049ff41872f6b0291a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_dbb992b1e69267c7b89e45307c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bd230c7339c22fed2aa387529e"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5e5340e04f80f443829089af80"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_d0e156af6bcda64dc420f44ae1"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_39eee28b1f5056d199f4ed2c1c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d94f28cc215bf9e685c73e014b"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_35ba530fe49310f0dc16748b55"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f04ca7b565c329d2a6f1b73c0f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_999e1e0b307266b4578e02fca5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bf00ca6c0fc2f9202dda9304ff"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3f53b37aabe10e2a1033d05b2c"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b8a59063604d0b6d659548da5a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_de6f7c888d6661227616ff312f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9484191f37ec856d966f87c0a4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d6329fff49d3b9f3c6b1dabb06"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_f0be597f225559f5550ef4d640"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_37768e6e1261ee85920f8a387d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_43714c4d2bdfcca2c28fa2c4ea"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_452076bf093c729d6fcf363a9f"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cec911f4e8121d16a8f9a7b031"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9ea179f3777f6d78a274a3f201"`);
