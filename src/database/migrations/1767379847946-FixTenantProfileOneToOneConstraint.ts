...
export class FixTenantProfileOneToOneConstraint1767379847946 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tenant_profiles" DROP CONSTRAINT "REL_b8a59063604d0b6d659548da5a"`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tenant_profiles" ADD CONSTRAINT "REL_b8a59063604d0b6d659548da5a" UNIQUE ("userId")`);
    }
